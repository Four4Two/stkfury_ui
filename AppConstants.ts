...
export const COSMOS_LIQUID_STAKE_URL = '/pstake.lscosmos.v1beta1.MsgLiquidStake'
export const COSMOS_LIQUID_UN_STAKE_URL = '/pstake.lscosmos.v1beta1.MsgLiquidUnstake'
