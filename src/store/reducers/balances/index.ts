...
import {BalanceState, FetchBalanceSaga, SetAtomBalance, SetIbcAtomBalance, SetStkAtomBalance} from "./types";
...
export const {setAtomBalance, setStkAtomBalance, setIbcAtomBalance, fetchBalanceSaga} = balances.actions
