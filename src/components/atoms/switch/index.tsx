...
export const Switch = ({
  ...
  <label className="relative inline-flex items-center cursor-pointer">
    <div className="relative">
      ...
      />
      <div
        className={`${styles[size]} ${size} switch bg-transparent border-[1.5px] !border-[#fcfcfc] peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#fcfcfc45] rounded-full
