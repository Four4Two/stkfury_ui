...
const UnStake = () => {
  const {apy, atomPrice} = useSelector((state:RootState) => state.initialData)
  return (
      <>
        <From/>
        <div className="swap-icon flex w-full items-center justify-center relative">
          <div className={`${styles.iconBox} icon-box rounded-full flex justify-center items-center absolute`}>
            <Icon
