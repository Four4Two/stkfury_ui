...
const DefiList = () => {
    ...
    const searchHandler = (evt:any) => {
        ...
        newDefiList = defiSwapList.filter((val) => {
            return val.inputToken.toLowerCase().includes(searchTerm.toLowerCase()) ||
        ...
        <div className={`${styles.defiContainer} px-2 pb-10 m-auto md:px-3`}>
            <div className="mb-8">
                ...
                <h6 className="text-base text-light-high text-center leading-normal md:text-sm">
                    ...
                    staking<br/> rewards across the COSMOS ecosystem
                </h6>
            </div>
            <Filters setSortActive={setSortActive} sortActive={sortActive} searchHandler={searchHandler}/>
            <CardList
